...
\IEEEcompsocitemizethanks{\IEEEcompsocthanksitem M. Dansereau is with the Department
...
The objectives of the projects are the following: 1) identify the objects in motion in a scene and extract some meaningful features. 2) classify the nature of the moving objects namely if they are pedestrians or cars. 3) Tracking of the moving objects and there respective trajectory.
...
The project was realized in python with the following libraries: numpy, scikitlearn, scikit-image
\section{Results}
\section{Conclusion}
